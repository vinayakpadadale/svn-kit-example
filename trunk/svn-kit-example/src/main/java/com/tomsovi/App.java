...
public class App 
{
	private static final String SVN_URL = "https://svn-kit-example.googlecode.com/svn/trunk";
    ...
    private void doSvnKitExample(String username, String password) {
        ...
        try {
        	...
        	String targetFolder = "target-folder-" + java.util.UUID.randomUUID().toString();
